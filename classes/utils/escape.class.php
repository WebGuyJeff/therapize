...
class Escape {
	...
	private const PATHS = array(
		'html_global' => THERAPIZE_PATH . 'data/htmlGlobalAttributes.json',
		'html_head'   => THERAPIZE_PATH . 'data/htmlHeadAttributes.json',
		'html_svg'    => THERAPIZE_PATH . 'data/htmlSVGAttributes.json',
		'css_props'   => THERAPIZE_PATH . 'data/cssProperties.json',
	);
